...
executed on Jetson TX2 platform. We used in our experiments real timing data from NVIDIA's
platform. Moreover, we implemented our
...
However, car manufactures do not forget at the end, in centralized
...
software will behaves under those conditions, in order to ensure a
...
we will discuss in more detail how the TX2 GPU scheduler behaves in case
...
apply to our study case. We discuss about Jetson TX2's memory hierarchy
...
each block regardless from which kernel \(\tau_i\) comes. In addition, it is
